...
ell_6ms_eigensolve_d(double eval[6], double _evec[36],
    ...
    while (sumoff/sumon > eps) {
        ...
        /*
         ...
         What this code is supposed to do (I think): copy the current matrix into another matrix
         Why this code doesn't work (I think): cur must not be 0 or 1, or mat must be the wrong size
         Possible fix: ?
         */
